...
int minimatrix_mat_xby (minimatrix * a, const minimatrix& b,double alpha, const minimatrix& c);
int minimatrix_mat_axby (minimatrix * a,double alpha, const minimatrix& b,double beta, const minimatrix& c);
