...
//       aword >>= 6;                     // The data had parity stripped
        ...
        case 52:
            ...
            if (word3==0)
                ...
                os << "RESERVED (NMCT status not stated)";
            os << "\n";
        ...
        case 54:
            os << "\n";
            if (almType==53)
                os << "Page Type: Subframe 4 Page 14, Reserved Bits\n";
            if (almType==54)
                os << "Page Type: Subframe 4 Page 15, Reserved Bits\n";
            // Hexadecimal dump
            os << "Hexadecimal dump of non-parity bits of words 3-10\n";
            os << " For historical reasons, the preceding statement\n";
            os << " NOT QUITE TRUE.  The actual bits (given in terms\n";
