...
throw()
{
    ...
    case SatID::systemGPS:
        if(n == 1)
            return L1_WAVELENGTH_GPS;
        else if(n == 2)
            return L2_WAVELENGTH_GPS;
        else if(n == 5)
            return L5_WAVELENGTH_GPS;
        break;
    case SatID::systemGlonass:
        if(n == 1)
            return (C_MPS/(L1_FREQ_GLO + N*L1_FREQ_STEP_GLO));
        else if(n == 2)
            return (C_MPS/(L2_FREQ_GLO + N*L2_FREQ_STEP_GLO));
        break;
    case SatID::systemGalileo:
        if(n == 1)
            return L1_WAVELENGTH_GAL;
        else if(n == 5)
            return L5_WAVELENGTH_GAL;
        else if(n == 6)
            return L6_WAVELENGTH_GAL;
        else if(n == 7)
            return L7_WAVELENGTH_GAL;
        else if(n == 8)
            return L8_WAVELENGTH_GAL;
        break;
    case SatID::systemGeosync:
        if(n == 1)
            return L1_WAVELENGTH_GEO;
        else if(n == 5)
            return L5_WAVELENGTH_GEO;
        break;
    case SatID::systemBeiDou:
        //MGEX data uses 2     if(n == 1) return L1_WAVELENGTH_BDS;
        if(n == 2)
            return L1_WAVELENGTH_BDS;
        else if(n == 7)
            return L2_WAVELENGTH_BDS;
        else if(n == 6)
            return L3_WAVELENGTH_BDS;
        break;
    case SatID::systemQZSS:
        if(n == 1)
            return L1_WAVELENGTH_QZS;
        else if(n == 2)
            return L2_WAVELENGTH_QZS;
        else if(n == 5)
            return L5_WAVELENGTH_QZS;
        else if(n == 6)
            return L6_WAVELENGTH_QZS;
        break;
    default:
        break;
    }
